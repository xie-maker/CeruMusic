import { httpFetch } from '../browserRequest'
...
export default {
  ...
  getInfo(id) {
    return createMusicuFetch({
      ...
      if (body.req_1.code != 0 || body.req_2.code != 0 || body.req_3.code != 0)
        throw new Error('get singer info failed.')
  ...
  getAlbumList(id, page = 1, limit = 10) {
    ...
    return createMusicuFetch({
      ...
      if (body.req.code != 0) throw new Error('get singer album failed.')
  ...
  async getSongList(id, page = 1, limit = 100) {
    ...
    return createMusicuFetch({
      ...
      if (body.req.code != 0) throw new Error('get singer song list failed.')
